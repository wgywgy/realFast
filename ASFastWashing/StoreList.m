...
//        if (second == NO) {
            tmpY = 4;
//            tmpY = scrollView.contentOffset.y;
//            NSLog(@"tmp:%f",tmpY);
//            second = ~second;
//        }
//        NSLog(@"s:%d",second);
