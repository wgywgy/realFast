...
-(BOOL)isSessionValid{
//#warning itswyy renren此处表明已经授权用的是NSUserDefaults
...
{
    RenrenPay *rrPay  = [[RenrenPay alloc] init];
 ...
 */
//#warning itswyy renren保存登陆后的信息到UserDefaluts中
...
//#warning itswyy renren删除UserDefaults中保存的用户oauth 2.0信息 
/**
