...
-(void)drawView{
    ...
    listView=[[UITableView alloc]initWithFrame:
              CGRectMake(0, oldFrame.size.height + 2,
                         oldFrame.size.width,
...
-(void)setShowList:(BOOL)b{
    ...
    if(showList){
        ...
        self.layer.shadowPath = [UIBezierPath bezierPathWithRect:
                                 CGRectMake(0, oldFrame.size.height,
